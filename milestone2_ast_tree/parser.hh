...
/**
 ** \file /compilers/compilers_course_4sem_2020/milestone1_naive_interpreter/parser.hh
...
#ifndef YY_YY_COMPILERS_COMPILERS_COURSE_4SEM_2020_MILESTONE1_NAIVE_INTERPRETER_PARSER_HH_INCLUDED
# define YY_YY_COMPILERS_COMPILERS_COURSE_4SEM_2020_MILESTONE1_NAIVE_INTERPRETER_PARSER_HH_INCLUDED
...
#line 55 "/compilers/compilers_course_4sem_2020/milestone1_naive_interpreter/parser.hh"
...
namespace yy {
#line 189 "/compilers/compilers_course_4sem_2020/milestone1_naive_interpreter/parser.hh"
...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    union union_type
    {
      ...
      // lvalue
      char dummy3[sizeof (std::pair<std::string, int>)];

      // expr
      char dummy4[sizeof (std::pair<std::vector<int>, bool>)];
...
#endif
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, std::pair<std::vector<int>, bool>&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const std::pair<std::vector<int>, bool>& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
switch (yytype)
    {
      ...
      case 49: // expr
        value.template destroy< std::pair<std::vector<int>, bool> > ();
        break;
    ...
    struct symbol_type : basic_symbol<by_type>
    {
      ...
      {
        YY_ASSERT (tok == token::TOK_END || tok == token::TOK_ASSIGN || tok == token::TOK_LPAREN || tok == token::TOK_RPAREN || tok == token::TOK_LPARENSQR || tok == token::TOK_RPARENSQR || tok == token::TOK_LPARENCRV || tok == token::TOK_RPARENCRV || tok == token::TOK_DOT || tok == token::TOK_COLON || tok == token::TOK_SEMICOLON || tok == token::TOK_NEW || tok == token::TOK_THIS || tok == token::TOK_TRUE || tok == token::TOK_FALSE || tok == token::TOK_IF || tok == token::TOK_ELSE || tok == token::TOK_WHILE || tok == token::TOK_ASSERT || tok == token::TOK_CLASS || tok == token::TOK_EXTENDS || tok == token::TOK_PUBLIC || tok == token::TOK_STATIC || tok == token::TOK_RETURN || tok == token::TOK_INT || tok == token::TOK_BOOL || tok == token::TOK_VOID || tok == token::TOK_MAIN || tok == token::TOK_SYSTEM || tok == token::TOK_OUT || tok == token::TOK_PRINTLN || tok == token::TOK_LENGTH || tok == 301 || tok == 302);
      }
#else
    ...
    , location (std::move (that.location))
  {
    switch (this->type_get ())
    {
      ...
      case 49: // expr
        value.move< std::pair<std::vector<int>, bool> > (std::move (that.value));
        break;
    ...
    , location (that.location)
  {
    switch (this->type_get ())
    {
      ...
      case 49: // expr
        value.copy< std::pair<std::vector<int>, bool> > (YY_MOVE (that.value));
        break;
  ...
  parser::basic_symbol<Base>::move (basic_symbol& s)
  {
    ...
    switch (this->type_get ())
    {
      ...
      case 49: // expr
        value.move< std::pair<std::vector<int>, bool> > (YY_MOVE (s.value));
        break;
...
#line 2069 "/compilers/compilers_course_4sem_2020/milestone1_naive_interpreter/parser.hh"





#endif // !YY_YY_COMPILERS_COMPILERS_COURSE_4SEM_2020_MILESTONE1_NAIVE_INTERPRETER_PARSER_HH_INCLUDED
