...
/**
 ** \file /compilers/compilers_course_4sem_2020/milestone4_scopes_types/parser.hh
...
#ifndef YY_YY_COMPILERS_COMPILERS_COURSE_4SEM_2020_MILESTONE4_SCOPES_TYPES_PARSER_HH_INCLUDED
# define YY_YY_COMPILERS_COMPILERS_COURSE_4SEM_2020_MILESTONE4_SCOPES_TYPES_PARSER_HH_INCLUDED
...
#line 59 "/compilers/compilers_course_4sem_2020/milestone4_scopes_types/parser.hh"
...
namespace yy {
#line 193 "/compilers/compilers_course_4sem_2020/milestone4_scopes_types/parser.hh"
...
#endif
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, std::shared_ptr<DeclList>&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const std::shared_ptr<DeclList>& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
#endif
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, std::shared_ptr<StmtList>&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const std::shared_ptr<StmtList>& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
#endif
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, std::shared_ptr<VarDecl>&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
...
switch (yytype)
    {
      ...
      case 59: // declaration_list
        value.template destroy< std::shared_ptr<DeclList> > ();
        break;
      ...
      case 58: // statement_list
        value.template destroy< std::shared_ptr<StmtList> > ();
        break;
    ...
    struct symbol_type : basic_symbol<by_type>
    {
      ...
      {
        YY_ASSERT (tok == token::TOK_END || tok == token::TOK_ASSIGN || tok == token::TOK_NOT || tok == token::TOK_LPAREN || tok == token::TOK_RPAREN || tok == token::TOK_LPARENSQR || tok == token::TOK_RPARENSQR || tok == token::TOK_LPARENCRV || tok == token::TOK_RPARENCRV || tok == token::TOK_DOT || tok == token::TOK_COLON || tok == token::TOK_SEMICOLON || tok == token::TOK_NEW || tok == token::TOK_THIS || tok == token::TOK_TRUE || tok == token::TOK_FALSE || tok == token::TOK_IF || tok == token::TOK_ELSE || tok == token::TOK_WHILE || tok == token::TOK_ASSERT || tok == token::TOK_CLASS || tok == token::TOK_EXTENDS || tok == token::TOK_PUBLIC || tok == token::TOK_STATIC || tok == token::TOK_RETURN || tok == token::TOK_INT || tok == token::TOK_BOOL || tok == token::TOK_VOID || tok == token::TOK_MAIN || tok == token::TOK_SYSTEM || tok == token::TOK_OUT || tok == token::TOK_PRINTLN || tok == token::TOK_LENGTH || tok == 302);
      }
#else
      ...
      {
        YY_ASSERT (tok == token::TOK_MINUS || tok == token::TOK_PLUS || tok == token::TOK_STAR || tok == token::TOK_SLASH || tok == token::TOK_AND || tok == token::TOK_OR || tok == token::TOK_LESS || tok == token::TOK_GREATER || tok == token::TOK_EQUAL || tok == token::TOK_RMNDR || tok == token::TOK_NUMBER);
      }
#else
    ...
    // Implementation of make_symbol for each symbol type.
      ...
      static
      symbol_type
      make_RMNDR (int v, location_type l)
      {
        return symbol_type (token::TOK_RMNDR, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      make_RMNDR (const int& v, const location_type& l)
      {
        return symbol_type (token::TOK_RMNDR, v, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      static
      symbol_type
      make_LPARENSQR (location_type l)
      {
        return symbol_type (token::TOK_LPARENSQR, std::move (l));
      }
#else
      static
      symbol_type
      make_LPARENSQR (const location_type& l)
      {
        return symbol_type (token::TOK_LPARENSQR, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_RPARENSQR (location_type l)
      {
        return symbol_type (token::TOK_RPARENSQR, std::move (l));
      }
#else
      static
      symbol_type
      make_RPARENSQR (const location_type& l)
      {
        return symbol_type (token::TOK_RPARENSQR, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_LPARENCRV (location_type l)
      {
        return symbol_type (token::TOK_LPARENCRV, std::move (l));
      }
#else
      static
      symbol_type
      make_LPARENCRV (const location_type& l)
      {
        return symbol_type (token::TOK_LPARENCRV, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_RPARENCRV (location_type l)
      {
        return symbol_type (token::TOK_RPARENCRV, std::move (l));
      }
#else
      static
      symbol_type
      make_RPARENCRV (const location_type& l)
      {
        return symbol_type (token::TOK_RPARENCRV, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
    ...
    , location (std::move (that.location))
  {
    switch (this->type_get ())
    {
      ...
      case 59: // declaration_list
        value.move< std::shared_ptr<DeclList> > (std::move (that.value));
        break;
      ...
      case 58: // statement_list
        value.move< std::shared_ptr<StmtList> > (std::move (that.value));
        break;

      case 61: // variable_declaration
      case 63: // local_variable_declaration
        value.move< std::shared_ptr<VarDecl> > (std::move (that.value));
        break;
    ...
    , location (that.location)
  {
    switch (this->type_get ())
    {
      ...
      case 59: // declaration_list
        value.copy< std::shared_ptr<DeclList> > (YY_MOVE (that.value));
        break;
      ...
      case 58: // statement_list
        value.copy< std::shared_ptr<StmtList> > (YY_MOVE (that.value));
        break;

      case 61: // variable_declaration
      case 63: // local_variable_declaration
        value.copy< std::shared_ptr<VarDecl> > (YY_MOVE (that.value));
        break;
  ...
  parser::basic_symbol<Base>::move (basic_symbol& s)
  {
    ...
    switch (this->type_get ())
    {
      ...
      case 59: // declaration_list
        value.move< std::shared_ptr<DeclList> > (YY_MOVE (s.value));
        break;
      ...
      case 58: // statement_list
        value.move< std::shared_ptr<StmtList> > (YY_MOVE (s.value));
        break;

      case 61: // variable_declaration
      case 63: // local_variable_declaration
        value.move< std::shared_ptr<VarDecl> > (YY_MOVE (s.value));
        break;
...
#line 2377 "/compilers/compilers_course_4sem_2020/milestone4_scopes_types/parser.hh"





#endif // !YY_YY_COMPILERS_COMPILERS_COURSE_4SEM_2020_MILESTONE4_SCOPES_TYPES_PARSER_HH_INCLUDED
